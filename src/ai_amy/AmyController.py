    ...
    def handle_idle(self):
        ...
        if idle_to_play and not self.IS_TEXT_INFERING:
            ...
            if idle_to_play.text:
                selected_text = random.choice(idle_to_play.text)
                if selected_text:
                    ...
                    self.main_window.root.after(0, self.handle_answer, selected_text)
                else:
                    self.main_window.text_output_window.set_text("")